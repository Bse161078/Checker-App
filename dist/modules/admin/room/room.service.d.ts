...
export declare class AdminRoomService {
    ...
    findAll(): Promise<(import("mongoose").Document<unknown, any, RoomDocument> & Room & Document & {
        _id: import("mongoose").Types.ObjectId;
    })[]>;
    findOne(id: string): Promise<import("mongoose").Document<unknown, any, RoomDocument> & Room & Document & {
        _id: import("mongoose").Types.ObjectId;
    }>;
